...
add_interface_port STSink_In_R STSink_In_R_Data data Input one_channel_sample_width
...
add_interface_port STSink_In_L STSink_In_L_Data data Input one_channel_sample_width
